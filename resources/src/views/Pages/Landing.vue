            ...
            <section class="section-shaped my-0">
                ...
                <div class="container shape-container d-flex">
                    <div class="col px-0">
                        <div class="row">
                            <div class="col-lg-6">
                                <h1 class="display-3  text-white">Adonis, Vue, Argon
                                    <span>Boilerplate Web Application</span>
                                </h1>
                                <p class="lead  text-white">Web Application Scaffolding for Rapid JavaScript Development</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row row-grid">
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-primary text-uppercase">Adonis Backend</h6>
                                    <p class="description mt-3">Adonis Js powers the backend of this application</p>
                                    <div>
                                        <badge type="primary" rounded>Build</badge>
                                        <badge type="primary" rounded>Deploy</badge>
                                        <badge type="primary" rounded>Scale</badge>
                                    </div>
                                    <base-button tag="a" href="https://adonisjs.com/docs/4.1/about" type="primary" class="mt-4">
                                        Adonis Docs
                                    </base-button>
                                </card>
                            </div>
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-success text-uppercase">Vue Js Frontend</h6>
                                    <p class="description mt-3">Vue Js is the framework of choice to power the frontend</p>
                                    <div>
                                        <badge type="success" rounded>Imagine</badge>
                                        <badge type="success" rounded>Design</badge>
                                        <badge type="success" rounded>Create</badge>
                                    </div>
                                    <base-button tag="a" href="https://vuejs.org/v2/guide/" type="success" class="mt-4">
                                        Vue Docs
                                    </base-button>
                                </card>
                            </div>
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-warning text-uppercase">Argon Design</h6>
                                    <p class="description mt-3">Argon is a great free UI package based on Bootstrap4</p>
                                    <div>
                                    ...
                                    <base-button tag="a" href="https://demos.creative-tim.com/vue-argon-design-system/documentation/" type="warning" class="mt-4">
                                        Argon Docs
                                    </base-button>
                                </card>
                            </div>
                ...
                <div class="row justify-content-center mt--300">
                    <div class="col-lg-8">
                        <card gradient="secondary" shadow body-classes="p-lg-5">
                            <base-alert v-if="formComplete === true" type="success" icon="ni ni-like-2">
                                <span slot="text"><strong>Success!</strong> Your message has been sent</span>
                            </base-alert>
                            <form v-if="formComplete !== true">
            ...
            <div class="container">
                <div class="row row-grid justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <p class="lead">Cause if you do, remember that it is open source and free to use</p>
                        <div class="text-center">
                            <h4 class="display-4 mb-5 mt-5">Built with these technologies</h4>
                            <div class="row justify-content-center">
